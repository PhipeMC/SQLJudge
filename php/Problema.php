...
<script>
    window.onload = function() {
        ...
        ?>
            var modalAgregar = new bootstrap.Modal(document.getElementById('<?php if ($_SESSION['statusProblem'] == 'AC') {
                                                                                echo 'modalEliminar';
                                                                                $_SESSION['statusProblem'] = null;
                                                                            }
                                                                            if ($_SESSION['statusProblem'] != 'AC' && $_SESSION['statusProblem'] != null) {
                                                                                echo 'error';
                                                                                $_SESSION['statusProblem'] = null;
                                                                            } ?>'), {
                keyboard: false
