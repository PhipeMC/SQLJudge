        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex">
                        <a class="btn btn-sm btn-outline-primary" href="../SQLJudge/php/logout.php">Cerrar sesión</a>
                    </form>
                </div>
            </div>
        </nav>
            ...
            <div class="form-container card-body">
                <form class="form row g-3 needs-validation" novalidate name="formulario" method="post" action="php/EditarProblema.php">
                    ...
                    <div class="col-md-6 g-3">
                        ...
                        <textarea class="form-control" name="consulta" id="consultaID" rows="15" required>s</textarea>
                        <div class="invalid-feedback">
